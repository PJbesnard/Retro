...
/**
 * Detector which had to be inherits by another Class to be used has a ClassVisitor which implements FeaturesObserver interface
 * @author PJBesnard
 *
 */
public class Detector extends ClassVisitor {
